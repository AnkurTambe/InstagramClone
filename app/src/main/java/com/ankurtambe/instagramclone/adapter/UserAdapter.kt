package com.ankurtambe.instagramclone.adapter
...
class UserAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.item_rv_search, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Picasso.get().load(user.getImage()).placeholder(R.drawable.profile_fill)
        ...
        holder.itemView.setOnClickListener(View.OnClickListener {
            ...
            (mContext as FragmentActivity).supportFragmentManager.beginTransaction()
                .replace(R.id.fl_main, ProfileFragment()).commit()
        })
